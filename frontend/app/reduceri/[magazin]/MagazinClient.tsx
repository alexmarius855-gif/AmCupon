    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <nav className="text-sm text-gray-500 flex items-center gap-1">
            <Link href="/" className="hover:text-[#d8c091] transition-colors">Reduceri</Link>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-8 flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-1">
              ...
              {m.exclusiv && (
                <span className="text-xs font-bold bg-[#b8912e] text-white px-2 py-0.5 rounded-full">
                  Exclusiv
                </span>
              )}
            </div>
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-4 text-sm mb-4">
              ...
              <div>
                ...
                <span className="font-semibold text-[#e3d1a6]">{m.promotii.length} active</span>
              </div>
            </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          {discount && (
                            <span className="text-sm font-black text-[#d8c091] bg-[#faf3e0] px-2 py-0.5 rounded-lg">
                              -{discount}
                            </span>
                          )}
                          {promo.cod_cupon && (
                        ...
                        {promo.cod_cupon ? (
                          isRevealed ? (
                            <div className="space-y-2">
                              <div className="border-2 border-dashed border-[#d8c091] rounded-xl py-2.5 px-3 text-center bg-[#faf3e0]">
                                <span className="font-mono font-black text-[#e3d1a6] tracking-widest text-sm">
                                  {promo.cod_cupon}
                                </span>
                                {isCopiat && (
                            ...
                            <button
                              ...
                              className="w-full border-2 border-dashed border-gray-300 hover:border-[#d8c091] rounded-xl py-2.5 px-3 text-center transition-colors group"
                            >
                              <span className="font-mono text-gray-400 group-hover:text-[#d8c091] text-sm">
                                {promo.cod_cupon.slice(0, 4)}{"*".repeat(Math.max(0, Math.min(promo.cod_cupon.length - 4, 6)))}
                              </span>
                              <p className="text-xs text-gray-400 mt-0.5 group-hover:text-[#d8c091]">
        ...
        <div className="mt-10 pt-6 border-t border-gray-100 text-center">
          <Link href="/" className="text-sm text-gray-400 hover:text-[#d8c091] transition-colors">
