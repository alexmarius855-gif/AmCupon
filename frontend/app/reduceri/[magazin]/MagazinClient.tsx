...
export default function MagazinClient({ magazin: m }: { magazin: Magazin }) {
  ...
  const culoriInitiala = [
    "bg-[#14b8a6]", "bg-green-500", "bg-[#14b8a6]", "bg-[#14b8a6]",
    "bg-[#14b8a6]", "bg-[#14b8a6]", "bg-red-500", "bg-yellow-500",
  ];
      ...
      <header className="bg-[#111827] border-b border-[#334155] sticky top-0 z-50 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <nav className="text-sm text-gray-500 flex items-center gap-1">
            <Link href="/" className="hover:text-[#0d9488] transition-colors">Reduceri</Link>
        ...
        <div className="bg-[#111827] rounded-xl border border-[#334155] shadow-sm p-6 mb-8 flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-1">
              ...
              {m.exclusiv && (
                <span className="text-xs font-bold bg-[#0d9488] text-white px-2 py-0.5 rounded-full">
                  Exclusiv
                </span>
              )}
            </div>
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-4 text-sm mb-4">
              ...
              {m.trend > 0 && (
                <div>
                  <span className="text-[#14b8a6]">↑ Trending </span>
                  <span className="font-semibold text-[#14b8a6]">+{m.trend}%</span>
                </div>
              )}
              <div>
                <span className="text-gray-400">Promoții: </span>
                <span className="font-semibold text-[#0f766e]">{m.promotii.length} active</span>
              </div>
            </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          ...
                          {promo.cod_cupon && (
                            <span className="text-xs font-bold text-[#14b8a6] bg-[#14b8a6] px-2 py-0.5 rounded-full uppercase tracking-wide">
                              Cod Reducere
                            </span>
                          )}
                          {promo.zile_ramase <= 3 && (
                        ...
                        {promo.cod_cupon ? (
                          isRevealed ? (
                            ...
                            >
                              ...
                              <p className="text-xs text-gray-400 mt-0.5 group-hover:text-[#0d9488]">
