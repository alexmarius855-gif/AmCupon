      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        <nav className="bg-[#F7F9FC] border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-[#64748b]">
            ...
            <span className="text-[#334155] font-medium">Sport & Fitness</span>
          </div>
        </nav>
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {SUBCATEGORII.map(s => (
                <a key={s.label} href={s.href}
                  className="flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-[#0f172a] text-sm font-semibold px-4 py-1.5 rounded-full border border-slate-200 transition-colors">
                  {s.emoji} {s.label}
                </a>
              ))}
            </div>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-[#0f172a]">Magazine sport cu reduceri active</h2>
          </div>
          {magazine.length === 0 ? (
              ...
              {magazine.map((m, i) => {
                ...
                return (
                  <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                    className="group bg-[#ffffff] border border-[#e2e8f0] hover:border-[#0f766e] rounded-xl p-4 transition-all hover:shadow-md">
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-[#0f172a] mb-5">Ghid: Echipament sport mai ieftin</h2>
            <div className="space-y-4 text-sm text-[#475569] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Cum economisești la echipament sport</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Cele mai bune perioade pentru cumpărături sport</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Echipament sport la cel mai mic preț</h3>
