...
const CULORI = ["bg-indigo-600","bg-indigo-600","bg-cyan-500","bg-indigo-600","bg-indigo-600","bg-cyan-600"];
      ...
      <div className="min-h-screen bg-slate-950">
        ...
        <nav className="bg-slate-950 border-b border-slate-800">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-slate-500">
            ...
            <span className="text-slate-300 font-medium">Supermarket Online</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-white mb-6 text-center">De ce sa comanzi online de la supermarket</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <h2 className="text-xl font-black text-white mb-5">Supermarketuri online cu reduceri active</h2>
          {magazine.length > 0 ? (
                ...
                return (
                  <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                    ...
                    <div className="flex justify-end mt-2">
                      <span className="text-xs text-blue-500 font-semibold group-hover:text-indigo-300">Vezi &rarr;</span>
                    </div>
                  </a>
                );
              })}
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-10 text-center">
              ...
              <p className="text-slate-500 text-sm mb-4">Revino curand pentru promotii la supermarketuri online.</p>
        ...
        <section className="bg-slate-900 border-t border-slate-800 py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-white mb-5">Ghid: Cumparaturi alimentare online — cum economisesti</h2>
            <div className="space-y-4 text-sm text-slate-400 leading-relaxed">
              <div>
                <h3 className="font-bold text-white mb-1">Carrefour vs Bringo vs Freshful</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Trucuri pentru cosul de cumparaturi mai mic</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Produse pe care merita sa le comanzi online</h3>
        ...
        <footer className="border-t border-slate-800 py-6 text-center text-xs text-slate-500 mt-4">
          ...
          <Link href="/casa" className="hover:text-indigo-400">Casa</Link>{" · "}
