...
const CULORI = ["bg-indigo-600","bg-indigo-600","bg-indigo-600","bg-indigo-600","bg-indigo-600","bg-red-400"];
      ...
      <div className="min-h-screen bg-slate-950">
        <nav className="bg-slate-950 border-b border-slate-800">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-slate-500">
            ...
            <span className="text-slate-300 font-medium">Parfumuri cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-white mb-6 text-center">Ce găsești la parfumuri online</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-white">Magazine parfumuri cu reduceri active</h2>
          </div>
                ...
                <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      {m.are_promotie && !m.cod_cupon && <span className="text-xs text-indigo-400 font-medium">Ofertă</span>}
                    </div>
                  </div>
                  {promo ? (
        ...
        <section className="bg-slate-900 border-t border-slate-800 py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-white mb-5">Ghid: Parfumuri originale ieftine în România</h2>
            <div className="space-y-4 text-sm text-slate-400 leading-relaxed">
              <div>
                <h3 className="font-bold text-white mb-1">Douglas vs Notino vs Sephora</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Parfumuri populare cu reduceri frecvente</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Când să cumperi</h3>
        ...
        <footer className="border-t border-slate-800 py-6 text-center text-xs text-slate-500 mt-4">
          © {an} AmCupon.ro ·{" "}
          <Link href="/frumusete" className="hover:text-indigo-400">Frumusețe</Link>{" · "}
