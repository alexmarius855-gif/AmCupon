...
const CATEG_COLOR: Record<string, { from: string; to: string; text: string; ring: string }> = {
  "Sanatate & Estetica":  { from: "#c3dd2c", to: "#ddf93c", text: "text-[#c3dd2c]",    ring: "hover:border-[#ddf93c]/30" },
  "Educatie & Cursuri":   { from: "#ddf93c", to: "#ddf93c", text: "text-[#c3dd2c]",  ring: "hover:border-[#ddf93c]/30" },
  "Software & SaaS":      { from: "#ddf93c", to: "#c3dd2c", text: "text-[#c3dd2c]",    ring: "hover:border-[#ddf93c]/30" },
  "Hosting":              { from: "#ddf93c", to: "#c3dd2c", text: "text-[#ddf93c]",   ring: "hover:border-[#ddf93c]/30" },
  "Telecomunicatii":      { from: "#ddf93c", to: "#ddf93c", text: "text-[#c3dd2c]",    ring: "hover:border-[#ddf93c]/30" },
...
const PAGINI_DEDICATE = [
  ...
  { href: "/software-business",     emoji: "📊", name: "Software Business",    sub: "SaaS cu comision mare",     from: "#ddf93c", to: "#c3dd2c" },
          ...
          {PAGINI_DEDICATE.map(item => (
            <Link key={item.href} href={item.href}
              ...
              <div className="relative">
                ...
                <div className="text-sm font-black text-[#ffffff]">{item.name}</div>
                ...
                return (
                  <div key={mag.magazin} className={`bg-[#14181c] border border-[#1f2329] ${culoare.ring} rounded-xl p-5 flex flex-col gap-3 transition-all`}>
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <div className="flex items-center gap-2 mb-0.5">
                          <span className="text-[#ffffff] font-black text-sm">{mag.magazin.split(".")[0].charAt(0).toUpperCase() + mag.magazin.split(".")[0].slice(1)}</span>
                    ...
                    <a href={mag.url_afiliat || `https://${mag.magazin}`} target="_blank" rel="sponsored noopener noreferrer"
                      className="mt-auto text-[#ffffff] text-xs font-bold py-2.5 rounded-lg text-center transition-all hover:-translate-y-0.5"
                      style={{ background: `linear-gradient(135deg, ${culoare.from}, ${culoare.to})` }}>
        ...
        <div className="relative overflow-hidden rounded-xl p-7" style={{ background: "linear-gradient(120deg, rgba(13,148,136,0.12), rgba(20,184,166,0.10), rgba(16,185,129,0.10))" }}>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/recomandari"
              className="text-[#ffffff] font-bold px-5 py-2.5 rounded-xl text-sm transition-all hover:-translate-y-0.5"
