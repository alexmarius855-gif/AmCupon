  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#e2e8f0] overflow-hidden" style={{ aspectRatio: "1" }}>
        ...
        {p.discount_pct > 0 && (
          <span className="absolute top-2 left-2 bg-gradient-to-br from-[#34d399] to-[#14b8a6] text-[#ffffff] text-[10px] font-black px-2 py-0.5 rounded-lg shadow">
            -{p.discount_pct}%
          </span>
        )}
        ...
        {p.discount_pct >= 30 && (
          <span className="absolute top-2 right-2 bg-gradient-to-r from-[#0d9488] to-[#14b8a6] text-white text-[9px] font-black px-1.5 py-0.5 rounded-full shadow uppercase tracking-wide">
            TOP DEAL
          </span>
        )}
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        ...
        {products.length === 0 ? (
          <div className="text-center py-20 bg-[#ffffff] rounded-xl border border-[#cbd5e1]">
            ...
            <Link href="/produse" className="bg-[#0d9488] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#14b8a6] transition-colors text-sm inline-block">
