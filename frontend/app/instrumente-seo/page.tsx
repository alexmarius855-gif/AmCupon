      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        ...
        <nav className="bg-[#ffffff]/80 backdrop-blur-sm border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-1.5 text-xs text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155] font-medium">Instrumente SEO</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-black text-[#0f172a]">Cele mai bune tool-uri SEO in {an}</h2>
          </div>
          <div className="space-y-4">
            {TOOLS_SEO.map(t => {
              ...
              return (
                <div key={t.slug} className="bg-[#ffffff] border border-[#e2e8f0] hover:border-emerald-500/30 rounded-xl p-6 transition-all duration-200">
                  <div className="flex flex-col sm:flex-row sm:items-start gap-5">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        <h3 className="text-xl font-black text-[#0f172a]">{t.name}</h3>
                        ...
                        <span className="text-[#475569] text-xs">{t.highlight}</span>
                      </div>
                      <p className="text-[#475569] text-sm leading-relaxed mb-4">{t.desc}</p>
                      <div className="flex flex-wrap gap-2 mb-4">
                        {t.features.map(f => (
                          <span key={f} className="bg-[#e2e8f0] border border-[#cbd5e1] text-[#334155] text-xs px-2.5 py-1 rounded-full">{f}</span>
                        ))}
                      </div>
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {mag ? (
                          ...
                          <a href={`https://www.${t.slug}`} target="_blank" rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 bg-[#cbd5e1] hover:bg-[#94a3b8] text-[#0f172a] text-sm font-bold px-4 py-2 rounded-xl transition-colors">
                            Site oficial
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-12 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-black text-[#0f172a]">Instrumente SEO gratuite recomandate</h2>
              <p className="text-[#475569] text-sm mt-2">Start ideal daca esti la inceput sau ai un buget limitat</p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {TOOLS_GRATUITE.map((t, i) => (
                <div key={t.nume} className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5 hover:border-[#14b8a6]/30 transition-all duration-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-[#0f172a] text-sm">{t.nume}</h3>
                  </div>
        ...
        <section className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-black text-[#0f172a]">Cum alegi tool-ul SEO potrivit</h2>
          </div>
          <div className="space-y-4">
            {GHID_SEO.map((g, i) => (
              <div key={i} className="bg-[#ffffff] border border-[#e2e8f0] rounded-xl p-6">
                ...
                <p className="text-sm text-[#475569] leading-relaxed">{g.continut}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-emerald-900/50 to-[#14b8a6]/50 border-t border-emerald-500/20 py-10 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-xl font-black text-[#0f172a] mb-2">Vrei alerte cand apare un cod Semrush?</h2>
            <p className="text-[#475569] text-sm mb-5">Abonat-te la newsletter-ul AmCupon — trimitem alerte gratuite cand apar coduri de reducere la tool-uri SEO si software.</p>
