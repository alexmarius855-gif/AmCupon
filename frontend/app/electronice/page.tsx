...
const CULORI = ["bg-[#0d9488]","bg-[#14b8a6]","bg-[#0d9488]","bg-[#14b8a6]","bg-[#0d9488]","bg-[#0d9488]"];
      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        <nav className="bg-[#F7F9FC] border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-[#64748b]">
            ...
            <span className="text-[#334155] font-medium">Electronice cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-[#0f172a] mb-6 text-center">Ce găsești la electronice online</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-[#0f172a]">Magazine electronice cu reduceri active</h2>
          </div>
                ...
                <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      {m.are_promotie && !m.cod_cupon && <span className="text-xs text-[#14b8a6] font-medium">Ofertă</span>}
                    </div>
                  </div>
                  {promo ? (
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-[#0f172a] mb-5">Ghid: Electronice ieftine online în România</h2>
            <div className="space-y-4 text-sm text-[#475569] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Cele mai bune momente să cumperi</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Top magazine electronice România</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Sfaturi economii</h3>
