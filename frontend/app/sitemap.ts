...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/esim`,                  lastModified: new Date(), changeFrequency: "weekly",  priority: 0.85 },
    ...
    { url: `${BASE_URL}/servicii-internationale`, lastModified: new Date(), changeFrequency: "weekly",  priority: 0.75 },
    { url: `${BASE_URL}/comparator`,              lastModified: new Date(), changeFrequency: "weekly",  priority: 0.75 },
    ...
    { url: `${BASE_URL}/amazon`,                  lastModified: new Date(), changeFrequency: "daily",   priority: 0.85 },
    { url: `${BASE_URL}/asos`,                    lastModified: new Date(), changeFrequency: "daily",   priority: 0.8  },
    { url: `${BASE_URL}/iherb`,                   lastModified: new Date(), changeFrequency: "weekly",  priority: 0.75 },
    { url: `${BASE_URL}/banggood`,                lastModified: new Date(), changeFrequency: "daily",   priority: 0.75 },
    ...
    { url: `${BASE_URL}/calculator-tva`,          lastModified: new Date(), changeFrequency: "monthly", priority: 0.8  },
