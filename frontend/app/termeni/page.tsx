  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-sm text-gray-400 mb-8">Ultima actualizare: Mai 2026</p>

        <div className="bg-white rounded-2xl border border-gray-200 p-8 space-y-8 text-gray-700 leading-relaxed">

          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">1. Despre AmCupon.ro</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">2. Linkuri de afiliere</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">3. Valabilitatea codurilor de reducere</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">4. Protecția datelor (GDPR)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">5. Cookie-uri</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">6. Răspundere</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 mb-3">7. Contact</h2>
            <p>
