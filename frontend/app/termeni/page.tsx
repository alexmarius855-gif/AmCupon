  ...
  return (
    <div className="min-h-screen bg-[#06080b]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-black text-[#ffffff] mb-2">Termeni și Condiții</h1>
        <p className="text-sm text-[#9399a0] mb-8">Ultima actualizare: Mai 2026</p>

        <div className="bg-[#14181c] rounded-xl border border-[#1f2329] p-8 space-y-8 text-[#c9ced5] leading-relaxed">

          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">1. Despre AmCupon.ro</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">2. Linkuri de afiliere</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">3. Valabilitatea codurilor de reducere</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">4. Protecția datelor (GDPR)</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">5. Cookie-uri</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">6. Răspundere</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-black text-[#ffffff] mb-3">7. Contact</h2>
            <p>
              Pentru orice întrebare legată de acești termeni sau de datele tale personale,
              ne poți contacta la:{" "}
              <a href="mailto:contact@amcupon.ro" className="text-[#ddf93c] hover:underline">
                contact@amcupon.ro
              </a>
            </p>
          </section>
