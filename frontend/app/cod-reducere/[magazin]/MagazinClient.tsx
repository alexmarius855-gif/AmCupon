        ...
        <section className="mt-10">
          ...
          <div className="bg-[#15120c] border border-[#26211a] rounded-2xl p-5">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
              {/* Comision */}
              <div className="bg-[#26211a] rounded-xl p-4 text-center">
                <p className="text-xs text-[#8c8064] uppercase tracking-wide mb-1">Comision</p>
                <p className="text-[#d8c091] font-black text-base leading-tight">
                  {m.comision?.replace("sale commission","").replace("Commission","").trim() || "Variabil"}
                </p>
              </div>
              {/* Canal */}
              <div className="bg-[#26211a] rounded-xl p-4 text-center">
                <p className="text-xs text-[#8c8064] uppercase tracking-wide mb-1">Canal</p>
              ...
              {/* Vanzari */}
              <div className="bg-[#26211a] rounded-xl p-4 text-center">
                <p className="text-xs text-[#8c8064] uppercase tracking-wide mb-1">Vanzari totale</p>
              ...
              {/* Prioritate */}
              <div className="bg-[#26211a] rounded-xl p-4 text-center">
                <p className="text-xs text-[#8c8064] uppercase tracking-wide mb-1">Prioritate</p>
            ...
            <div className="border-t border-[#26211a] pt-4">
              <p className="text-xs font-bold text-[#a89a78] uppercase tracking-widest mb-3">Poti vinde produse?</p>
              <div className="flex flex-wrap gap-2">
                ...
                {m.canal_recomandat?.toLowerCase().includes("cashback") && (
                  <span className="flex items-center gap-1.5 bg-[#c9a63e]/10 text-[#d8c091] border border-[#c9a63e]/20 text-xs font-bold px-3 py-1.5 rounded-full">
                    ✅ Cashback
                  </span>
                )}
                ...
                <span className="flex items-center gap-1.5 bg-[#26211a] text-[#a89a78] border border-[#37301f] text-xs font-bold px-3 py-1.5 rounded-full">
                  🔗 Quicklinks permise
                </span>
              </div>
              <p className="text-xs text-[#8c8064] mt-3">
