...
const CULORI = ["bg-indigo-600","bg-indigo-600","bg-indigo-600","bg-indigo-500","bg-indigo-600","bg-indigo-600"];
      ...
      <div className="min-h-screen bg-slate-950">
        <nav className="bg-slate-950 border-b border-slate-800">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-slate-500">
            ...
            <span className="text-slate-300 font-medium">Fashion & Haine cu Reducere</span>
          </div>
        </nav>
              ...
              return (
                <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                  ...
                  <div className="flex justify-end mt-2">
                    <span className="text-xs text-indigo-400 font-semibold group-hover:text-indigo-400">Vezi &rarr;</span>
                  </div>
                </a>
              );
            })}
