...
const CULORI = ["bg-[#0d9488]","bg-[#0d9488]","bg-[#0d9488]","bg-[#14b8a6]","bg-[#0d9488]","bg-[#0d9488]"];
      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        <nav className="bg-[#F7F9FC] border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-[#64748b]">
            ...
            <span className="text-[#334155] font-medium">Fashion & Haine cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-[#0f172a] mb-6 text-center">Ce gasesti la magazine fashion online</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-[#0f172a]">Magazine fashion cu reduceri active</h2>
          </div>
              ...
              return (
                <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                  ...
                  <div className="flex justify-end mt-2">
                    <span className="text-xs text-[#0d9488] font-semibold group-hover:text-[#0d9488]">Vezi &rarr;</span>
                  </div>
                </a>
              );
            })}
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-[#0f172a] mb-5">Ghid: Haine online mai ieftine in Romania</h2>
            <div className="space-y-4 text-sm text-[#475569] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">FashionDays vs Answear vs H&M</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Cele mai bune perioade pentru cumparaturi fashion</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Cum economisesti la haine online</h3>
