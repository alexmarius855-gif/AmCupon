...
const CULORI = ["bg-[#b8912e]","bg-[#b8912e]","bg-[#b8912e]","bg-[#c9a63e]","bg-[#b8912e]","bg-[#b8912e]"];
      ...
      <div className="min-h-screen bg-[#0b0a07]">
        <nav className="bg-[#0b0a07] border-b border-[#26211a]">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-[#8c8064]">
            ...
            <span className="text-[#c8bda2] font-medium">Fashion & Haine cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-white mb-6 text-center">Ce gasesti la magazine fashion online</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-white">Magazine fashion cu reduceri active</h2>
          </div>
              ...
              return (
                <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                  ...
                  <div className="flex justify-end mt-2">
                    <span className="text-xs text-[#d8c091] font-semibold group-hover:text-[#d8c091]">Vezi &rarr;</span>
                  </div>
                </a>
              );
            })}
        ...
        <section className="bg-[#15120c] border-t border-[#26211a] py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-white mb-5">Ghid: Haine online mai ieftine in Romania</h2>
            <div className="space-y-4 text-sm text-[#a89a78] leading-relaxed">
              <div>
                <h3 className="font-bold text-white mb-1">FashionDays vs Answear vs H&M</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Cele mai bune perioade pentru cumparaturi fashion</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Cum economisesti la haine online</h3>
        ...
        <footer className="border-t border-[#26211a] py-6 text-center text-xs text-[#8c8064] mt-4">
          © {an} AmCupon.ro ·{" "}
          <Link href="/frumusete" className="hover:text-[#d8c091]">Frumusete</Link>{" · "}
