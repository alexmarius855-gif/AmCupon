      ...
      <div className="max-w-4xl mx-auto bg-gray-900 text-white rounded-2xl shadow-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1 text-sm">
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            <Link href="/confidentialitate" className="text-[#d8c091] hover:underline">
        ...
        <div className="flex gap-2 shrink-0 w-full sm:w-auto">
          ...
          <button
            onClick={accept}
            className="flex-1 sm:flex-none px-5 py-2 rounded-xl bg-[#b8912e] hover:bg-[#c9a63e] text-white text-sm font-bold transition-colors"
          >
            Accept
          </button>
        </div>
