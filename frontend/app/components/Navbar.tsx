        ...
        <nav className="hidden md:flex items-center gap-4 text-sm font-semibold text-slate-600 ml-auto shrink-0">
          ...
          <div className="flex items-center gap-1.5 border-l border-slate-200 pl-4 ml-1">
            <a href="https://www.facebook.com/amcupon.ro" target="_blank" rel="noopener noreferrer" aria-label="Facebook AmCupon"
              className="w-8 h-8 rounded-lg bg-slate-100 hover:bg-[#1877F2] flex items-center justify-center transition-colors group">
              <svg className="w-3.5 h-3.5 text-slate-500 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/amcupon.ro" target="_blank" rel="noopener noreferrer" aria-label="Instagram AmCupon"
              className="w-8 h-8 rounded-lg bg-slate-100 hover:bg-gradient-to-br hover:from-purple-600 hover:to-orange-400 flex items-center justify-center transition-colors group">
              <svg className="w-3.5 h-3.5 text-slate-500 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
            ...
            <a href="https://www.tiktok.com/@amcupon.ro" target="_blank" rel="noopener noreferrer" aria-label="TikTok AmCupon"
              className="w-8 h-8 rounded-lg bg-slate-100 hover:bg-black flex items-center justify-center transition-colors group">
              <svg className="w-3.5 h-3.5 text-slate-500 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
