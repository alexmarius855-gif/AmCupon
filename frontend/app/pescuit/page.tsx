        ...
        <section className="bg-gradient-to-br from-emerald-800 via-green-800 to-[#111827] text-[#f1f5f9] py-12 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {BRANDURI.map(b => (
                <span key={b} className="bg-slate-100 text-[#f1f5f9] text-sm font-semibold px-4 py-1.5 rounded-full border border-slate-200">
                  {b}
                </span>
              ))}
            </div>
              ...
              {magazine.map((m, i) => {
                ...
                return (
                  <a key={m.magazin} href={`/cod-reducere/${m.magazin}`}
                    className="group bg-[#111827] border border-[#1e293b] hover:border-emerald-500/40 rounded-xl p-4 transition-all hover:shadow-md">
