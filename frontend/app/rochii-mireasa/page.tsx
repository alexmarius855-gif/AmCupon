        ...
        <section className="relative bg-[#0b0a07] border-b border-[#26211a] overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 pt-12 pb-10 text-center">
            <nav className="flex justify-center gap-2 text-xs text-[#8c8064] mb-8">
              ...
              <span>/</span>
              <span className="text-[#c8bda2]">Rochii Mireasa & Ocazie</span>
            </nav>
            <div className="text-5xl mb-4">👰</div>
            <h1 className="text-4xl md:text-5xl font-black text-white mb-4">
              Rochii de <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, #b8912e, #b8912e)" }}>Mireasa</span> & Ocazie {an}
            </h1>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <section className="mt-10 bg-[#15120c] border border-[#26211a] rounded-2xl p-6">
            ...
            <ul className="space-y-2 text-sm text-[#a89a78]">
              <li><strong className="text-[#dcd0b8]">Comanda din timp</strong> — rochiile de mireasa personalizate pot dura 4-8 saptamani de la comanda</li>
              <li><strong className="text-[#dcd0b8]">Domnisoare de onoare</strong> — alege un model usor de reprodus in mai multe marimi, nu personalizat excesiv</li>
              <li><strong className="text-[#dcd0b8]">Invitata la nunta</strong> — evita albul si nuantele foarte deschise, verifica dress code-ul</li>
              <li><strong className="text-[#dcd0b8]">Reduceri sezoniere</strong> — cele mai mari reduceri la rochii de ocazie apar dupa Craciun si dupa sezonul de nunti (sept-oct)</li>
            </ul>
          </section>
