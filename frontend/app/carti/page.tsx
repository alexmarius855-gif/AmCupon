      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        <nav className="bg-[#F7F9FC] border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-[#64748b]">
            ...
            <span className="text-[#334155] font-medium">Cărți Online cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-[#0f172a] mb-6 text-center">Ce găsești la librăriile online</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-[#0f172a]">Librării online cu reduceri active</h2>
          </div>
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-[#0f172a] mb-5">Ghid: Cărți ieftine online în România</h2>
            <div className="space-y-4 text-sm text-[#475569] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Libris vs Elefant vs Cărturești</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Cărți populare cu reduceri frecvente</h3>
              ...
              <div>
                <h3 className="font-bold text-[#0f172a] mb-1">Economisește la cărți</h3>
