      ...
      <div className="min-h-screen bg-[#0b0a07]">
        <nav className="bg-[#0b0a07] border-b border-[#26211a]">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-[#8c8064]">
            ...
            <span className="text-[#c8bda2] font-medium">Frumusețe & Beauty</span>
          </div>
        </nav>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {SUBCATEGORII.map(s => (
              <a key={s.label} href="/categorii/beauty"
                ...
                <p className="text-xs text-[#a89a78] mb-3">{s.desc}</p>
                <p className="text-xs font-bold text-[#d8c091] group-hover:text-[#d8c091]">Vezi reduceri →</p>
              </a>
            ))}
          </div>
        </section>
        ...
        <footer className="border-t border-[#26211a] py-6 text-center text-xs text-[#8c8064] mt-4">
          ...
          <Link href="/categorii/beauty" className="hover:text-[#d8c091]">Categorie Beauty</Link>{" · "}
