...
const CULORI_BADGE = ["bg-[#0d9488]","bg-[#0d9488]","bg-[#0d9488]","bg-emerald-600","bg-[#0d9488]","bg-[#14b8a6]","bg-green-600","bg-[#0d9488]"];
      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        ...
        <nav className="bg-[#ffffff]/80 backdrop-blur-sm border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-1.5 text-xs text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155] font-medium">Telefoane cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-black text-[#0f172a]">Alege telefonul dupa buget</h2>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h2 className="text-xl font-black text-[#0f172a]">Magazine telefoane cu reduceri active</h2>
            </div>
          </div>
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-12 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-black text-[#0f172a] mb-7">Ce telefon sa cumperi in {an}</h2>
            <div className="space-y-5">
              <div className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5">
                <h3 className="font-bold text-[#0f172a] mb-3 text-base">Cele mai bune branduri in {an}</h3>
              ...
              <div className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5">
                <h3 className="font-bold text-[#0f172a] mb-2 text-base">Android sau iPhone — care e mai bun?</h3>
                <p className="text-sm text-[#475569] leading-relaxed">Daca ai deja Mac/iPad, iPhone se integreaza perfect. Daca vrei flexibilitate maxima si pret mai bun la specificatii similare, Samsung sau Xiaomi sunt alegeri mai inteligente. Xiaomi Redmi Note 13 Pro+ ofera camera 200MP si incarcare 67W la 1.600 lei — raport calitate-pret greu de batut.</p>
              </div>
              <div className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5">
                <h3 className="font-bold text-[#0f172a] mb-3 text-base">Cand sa cumperi un telefon mai ieftin</h3>
