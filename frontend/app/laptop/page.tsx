      ...
      <div className="min-h-screen bg-[#0a0f1a]">
        ...
        <nav className="bg-[#111827]/80 backdrop-blur-sm border-b border-[#1e293b]">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-1.5 text-xs text-[#94a3b8]">
            ...
            <span>/</span>
            <span className="text-[#cbd5e1] font-medium">Laptop Ieftin</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-black text-[#f1f5f9]">Alege laptopul dupa buget</h2>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h2 className="text-xl font-black text-[#f1f5f9]">Magazine laptopuri cu reduceri active</h2>
            </div>
          </div>
        ...
        <section className="bg-[#111827] border-t border-[#1e293b] py-12 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-black text-[#f1f5f9] mb-7">Ce laptop sa cumperi in {an}</h2>
            <div className="space-y-5">
              <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-5">
                <h3 className="font-bold text-[#f1f5f9] mb-3 text-base">Cele mai bune branduri laptop in {an}</h3>
              ...
              <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-5">
                <h3 className="font-bold text-[#f1f5f9] mb-3 text-base">Ce specificatii conteaza cu adevarat</h3>
              ...
              <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-5">
                <h3 className="font-bold text-[#f1f5f9] mb-2 text-base">Cand sunt cele mai mari reduceri la laptopuri</h3>
                <p className="text-sm text-[#cbd5e1] leading-relaxed">Black Friday (noiembrie) si Zilele eMAG (mai, octombrie) aduc reduceri de 20-35% la laptopuri. Verifica codurile AmCupon pentru discount suplimentar de 5-10% aplicabil pe langa promotia activa.</p>
              </div>
            </div>
          </div>
        </section>
