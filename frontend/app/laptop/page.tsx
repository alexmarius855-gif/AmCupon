...
const BUGETE = [
  ...
  { pret: "2.000 – 3.500 lei", emoji: "💻", desc: "Office, multitasking, student productivitate", culoare: "bg-[#0d9488]" },
  { pret: "3.500 – 5.000 lei", emoji: "⚡", desc: "Laptop gaming entry, creatori continut", culoare: "bg-[#0d9488]" },
  { pret: "Peste 5.000 lei", emoji: "🚀", desc: "Gaming high-end, workstation, MacBook", culoare: "bg-[#0d9488]" },
];
      ...
      <div className="min-h-screen bg-[#F7F9FC]">
        ...
        <nav className="bg-[#ffffff]/80 backdrop-blur-sm border-b border-[#e2e8f0]">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-1.5 text-xs text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155] font-medium">Laptop Ieftin</span>
          </div>
        </nav>

        {/* Hero */}
        <section className="relative overflow-hidden bg-gradient-to-br from-[#ffffff] via-[#ffffff] to-[#ffffff] py-16 px-4">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#14b8a6]/20 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-[#0d9488]/20 rounded-full blur-3xl" />
          </div>
          <div className="relative max-w-6xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-4 tracking-tight">
              Laptop Ieftin Romania <span className="text-transparent bg-clip-text" style={{backgroundImage:"linear-gradient(135deg, #0d9488, #0f766e)"}}>{an}</span>
            </h1>
        ...
        <section className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-black text-[#0f172a]">Alege laptopul dupa buget</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {BUGETE.map(b => (
              <div key={b.pret} className="bg-[#ffffff] border border-[#e2e8f0] hover:border-[#14b8a6]/40 rounded-xl p-5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#14b8a6]/10">
                <div className={`w-11 h-11 ${b.culoare} rounded-xl flex items-center justify-center text-2xl mb-4`}>{b.emoji}</div>
                <h3 className="font-black text-[#0f172a] text-base mb-1.5">{b.pret}</h3>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h2 className="text-xl font-black text-[#0f172a]">Magazine laptopuri cu reduceri active</h2>
            </div>
          </div>
        ...
        <section className="bg-[#ffffff] border-t border-[#e2e8f0] py-12 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-black text-[#0f172a] mb-7">Ce laptop sa cumperi in {an}</h2>
            <div className="space-y-5">
              <div className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5">
                <h3 className="font-bold text-[#0f172a] mb-3 text-base">Cele mai bune branduri laptop in {an}</h3>
                <div className="grid sm:grid-cols-2 gap-3">
                  {BRANDURI.map(b => (
                    <div key={b.brand} className="bg-[#ffffff] border border-[#cbd5e1] rounded-xl p-3">
                      <p className="font-bold text-[#0f172a] text-xs mb-1">{b.brand}</p>
                      <p className="text-xs text-[#475569]">{b.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              <div className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5">
                <h3 className="font-bold text-[#0f172a] mb-3 text-base">Ce specificatii conteaza cu adevarat</h3>
              ...
              <div className="bg-[#e2e8f0] border border-[#cbd5e1] rounded-xl p-5">
                <h3 className="font-bold text-[#0f172a] mb-2 text-base">Cand sunt cele mai mari reduceri la laptopuri</h3>
                <p className="text-sm text-[#475569] leading-relaxed">Black Friday (noiembrie) si Zilele eMAG (mai, octombrie) aduc reduceri de 20-35% la laptopuri. Verifica codurile AmCupon pentru discount suplimentar de 5-10% aplicabil pe langa promotia activa.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <footer className="border-t border-[#e2e8f0] py-6 text-center text-xs text-[#94a3b8]">
          ...
          <Link href="/gaming" className="hover:text-[#0d9488] transition-colors">Gaming</Link>{" · "}
