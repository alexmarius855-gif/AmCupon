      ...
      <div className="min-h-screen bg-slate-950">
        <nav className="bg-slate-950 border-b border-slate-800">
          <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center gap-1 text-xs text-slate-500">
            ...
            <span className="text-slate-300 font-medium">Casa & Gradina cu Reducere</span>
          </div>
        </nav>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          <h2 className="text-xl font-black text-white mb-6 text-center">Ce gasesti la magazine casa & gradina</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-xl font-black text-white">Magazine casa cu reduceri active</h2>
          </div>
        ...
        <section className="bg-slate-900 border-t border-slate-800 py-10 px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-xl font-black text-white mb-5">Ghid: Amenajari casa mai ieftine in Romania</h2>
            <div className="space-y-4 text-sm text-slate-400 leading-relaxed">
              <div>
                <h3 className="font-bold text-white mb-1">Dedeman vs IKEA vs Leroy Merlin</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Cand sa cumperi mobila si electrocasnice</h3>
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Sfaturi economii amenajari</h3>
